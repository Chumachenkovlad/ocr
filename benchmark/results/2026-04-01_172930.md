...
| --- | --- | --- | --- | --- |
| dense-twocol.png | 2295 | 3621 | 2998 | 2422 |
| form-kvpairs.png | 2393 | 3347 | 3418 | 1840 |
| low-dpi.png | 4297 | 1358 | 2019 | 529 |
| mixed-content.png | 1737 | 3275 | 3074 | 1748 |
| multilingual.png | 2275 | 3194 | 2664 | 1844 |
| multipage.pdf | 7592 | 9214 | ERR | 5171 |
| noisy-scan.png | 4195 | 11890 | 4691 | 9538 |
| simple-typed.png | 4680 | 3356 | 3200 | 2343 |
| table-complex.png | 1617 | 3376 | 4549 | 1664 |
| table-simple.png | 2072 | 3047 | 2601 | 1703 |

### Aggregate latency

| Provider | p50 | p95 | mean |
| --- | --- | --- | --- |
| doctr | 2798 | 7592 | 3316 |
| paddle | 3517 | 11890 | 4633 |
| surya | 3157 | 5463 | 3414 |
| tesseract | 2079 | 9538 | 2930 |
...
| table-complex.png | 14 / 8 / 1 | 100 / 88 / 1 | 99 / 88 / 4 | 86 / 13 / 5 |
...
| table-complex.png | 0.782 ±0.225 [0.41–1.00] | 0.994 ±0.013 [0.98–1.00] | 0.671 ±0.110 [0.53–0.83] | 0.907 ±0.083 [0.83–0.96] |
...
| table-complex.png | 0.366 | 0.274 | 0.169 | 0.474 | 0.341 | 0.235 |
| table-simple.png | 0.679 | 0.519 | 0.436 | 0.760 | 0.658 | 0.672 |

### Mean similarity

- **doctr_vs_paddle**: 0.483
- **doctr_vs_surya**: 0.373
- **doctr_vs_tesseract**: 0.427
- **paddle_vs_surya**: 0.613
- **paddle_vs_tesseract**: 0.558
- **surya_vs_tesseract**: 0.482

## Run-to-run variance (multi-run mode)

| Fixture | doctr | paddle | surya | tesseract |
| --- | --- | --- | --- | --- |
| dense-twocol.png | σ=318ms CV=13.07% | σ=350ms CV=9.28% | σ=356ms CV=11.85% | σ=273ms CV=10.90% |
| form-kvpairs.png | σ=301ms CV=11.74% | σ=308ms CV=8.82% | σ=277ms CV=7.81% | σ=329ms CV=16.27% |
| low-dpi.png | σ=412ms CV=9.31% | σ=267ms CV=18.52% | σ=228ms CV=10.92% | σ=190ms CV=32.95% |
| mixed-content.png | σ=279ms CV=15.11% | σ=284ms CV=8.55% | σ=310ms CV=9.72% | σ=261ms CV=14.54% |
| multilingual.png | σ=361ms CV=14.67% | σ=314ms CV=9.45% | σ=301ms CV=10.69% | σ=262ms CV=13.71% |
| multipage.pdf | σ=105ms CV=1.39% | σ=201ms CV=2.16% | ERR | σ=230ms CV=4.34% |
| noisy-scan.png | σ=635ms CV=16.51% | σ=674ms CV=5.82% | σ=2113ms CV=38.51% | σ=563ms CV=6.09% |
| simple-typed.png | σ=669ms CV=15.21% | σ=328ms CV=9.40% | σ=398ms CV=13.63% | σ=280ms CV=11.23% |
| table-complex.png | σ=229ms CV=15.34% | σ=212ms CV=6.16% | σ=574ms CV=11.95% | σ=196ms CV=11.87% |
| table-simple.png | σ=279ms CV=13.01% | σ=325ms CV=10.24% | σ=269ms CV=9.91% | σ=251ms CV=14.01% |
...
| Metric | Ranking |
| --- | --- |
| Speed | tesseract (2930ms) > doctr (3316ms) > surya (3414ms) > paddle (4633ms) |
| Words extracted | surya (163) > tesseract (159) > paddle (155) > doctr (119) |
| Avg confidence | paddle (0.940) > tesseract (0.868) > surya (0.830) > doctr (0.784) |

### Text agreement between providers

- **Most agreeing pair**: paddle_vs_surya (0.613)
- **Least agreeing pair**: doctr_vs_surya (0.373)

### Use-case recommendations

| Use case | Recommended | Reason |
| --- | --- | --- |
| Real-time / latency-sensitive | **tesseract** | lowest mean latency (2930ms) |
| Maximum text extraction (recall) | **surya** | most words on average (163) |
...
- **surya** on `multipage.pdf`: Server error '500 Internal Server Error' for url 'http://3.237.3.2:8083/api/v1/ocr'
For more information check: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/500
- **surya** on `multipage.pdf`: Server error '500 Internal Server Error' for url 'http://3.237.3.2:8083/api/v1/ocr'
For more information check: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/500
- **surya** on `multipage.pdf`: Server error '500 Internal Server Error' for url 'http://3.237.3.2:8083/api/v1/ocr'
For more information check: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/500
- **surya** on `simple-typed.png`: [Errno 61] Connection refused
